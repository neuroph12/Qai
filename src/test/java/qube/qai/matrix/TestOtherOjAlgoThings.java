...
import org.ojalgo.type.ChartBuilder;
 ...
 */
public class TestOtherOjAlgoThings extends TestCase {

    private boolean debug = true;

    public void restOjAlgoFinance() throws Exception {
        YahooSymbol goog = new YahooSymbol("GOOG");
        CalendarDateSeries<Double> dateSeriesGoog = goog.getPriceSeries();

        String dateSeries = dateSeriesGoog.toString();
        log(dateSeries);
